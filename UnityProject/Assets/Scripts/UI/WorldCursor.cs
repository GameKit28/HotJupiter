...
namespace HotJupiter
{
	public class WorldCursor : MonoBehaviour
	{
		...
		void Update()
		{
			...
			hexMeshRenderer.material.color = Color.Lerp(
				Color.white,
				HexMapUI.GetLevelColor(HexMapUI.currentUIMapLevel),
		...
		{
			hexTileMesh.GenerateMeshFromTile(
				new Tile(HighlightedTile, HexMapUI.currentUIMapLevel),
				hexMeshFilter.transform
			);
		}
